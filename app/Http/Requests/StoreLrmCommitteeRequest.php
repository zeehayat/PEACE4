...
class StoreLrmCommitteeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'target_forest_area_value' => ['nullable', 'numeric', 'min:0'],
            'target_forest_area_unit' => ['nullable', 'string', 'max:50'],
            'target_fruit_area_value' => ['nullable', 'numeric', 'min:0'],
            'target_fruit_area_unit' => ['nullable', 'string', 'max:50'],
            'target_forest_plants_count' => ['nullable', 'integer', 'min:0'],
            'target_fruit_plants_count' => ['nullable', 'integer', 'min:0'],
            'target_drr_training_persons' => ['nullable', 'integer', 'min:0'],
            'target_check_dams_value' => ['nullable', 'numeric', 'min:0'],
            'target_check_dams_unit' => ['nullable', 'string', 'max:50'],
            'target_greenbelt_lawn_value' => ['nullable', 'numeric', 'min:0'],
            'target_greenbelt_lawn_unit' => ['nullable', 'string', 'max:50'],
            'target_composting_training_persons' => ['nullable', 'integer', 'min:0'],
            'target_pest_control_training_persons' => ['nullable', 'integer', 'min:0'],
            'target_pest_control_kits' => ['nullable', 'integer', 'min:0'],
