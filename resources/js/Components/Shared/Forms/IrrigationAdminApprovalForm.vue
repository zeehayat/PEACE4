    ...
    <form @submit.prevent="submit" class="space-y-4 p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
            ...
            <div class="col-span-full">
                ...
                <input type="text" :value="irrigationSchemeId" id="irrigation_scheme_id" class="input-compact bg-paper-100" readonly />
            </div>

            <!-- EU Approval Date -->
            <div>
                <label for="eu_approval_date" class="block text-sm font-medium text-ink-700 mb-1">EU Approval Date</label>
            ...
            <!-- Approved Cost -->
            <div>
                <label for="approved_cost" class="block text-sm font-medium text-ink-700 mb-1">Approved Cost</label>
            ...
            <div>
                <label for="date_design_estimates_submission_psu" class="block text-sm font-medium text-ink-700 mb-1">Design Submitted to PSU</label>
            ...
            <div>
                <label for="date_design_estimates_submission_opm_eu_review" class="block text-sm font-medium text-ink-700 mb-1">Design Submitted to OPM/EU for Review</label>
            ...
            <div>
                <label for="date_validation_visit_opm" class="block text-sm font-medium text-ink-700 mb-1">Validation Visit by OPM</label>
            ...
            <div>
                <label for="civil_work_start_date" class="block text-sm font-medium text-ink-700 mb-1">Civil Work Start Date</label>
            ...
            <div>
                <label for="scheme_inauguration_date" class="block text-sm font-medium text-ink-700 mb-1">Scheme Inauguration Date</label>
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <button type="button" @click="emit('cancel')" class="px-4 py-2 border border-ink-300 rounded-md shadow-sm text-sm font-medium text-ink-700 bg-surface hover:bg-paper-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500">
                Cancel
            </button>
