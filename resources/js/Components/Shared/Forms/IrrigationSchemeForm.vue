...
<template>
    <form @submit.prevent="submit" class="p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <!-- Status -->
            <div>
                <label for="status" class="block text-sm font-medium text-ink-700 mb-1">Status</label>
            ...
            <!-- Beneficiary Farmers -->
            <div>
                <label for="beneficiary_farmers" class="block text-sm font-medium text-ink-700 mb-1">Beneficiary Farmers</label>
            ...
            <!-- Channel Length -->
            <div>
                <label for="channel_length_km" class="block text-sm font-medium text-ink-700 mb-1">Channel Length (km)</label>
            ...
            <!-- Land Area -->
            <div>
                <label for="land_area_hectares" class="block text-sm font-medium text-ink-700 mb-1">Land Area (Hectares)</label>
            ...
            <div>
                <label for="month_year_establishment" class="block text-sm font-medium text-ink-700 mb-1">Month/Year of Establishment</label>
            ...
            <!-- Established By -->
            <div>
                <label for="established_by" class="block text-sm font-medium text-ink-700 mb-1">Established By</label>
            ...
            <!-- Technical Surveys -->
            <div>
                <label for="date_technical_surveys" class="block text-sm font-medium text-ink-700 mb-1">Date of Technical Surveys</label>
            ...
            <div>
                <label for="date_completion_civil_works" class="block text-sm font-medium text-ink-700 mb-1">Date of Completion Civil Works</label>
            ...
            <!-- Handover Date -->
            <div>
                <label for="handover_to_community_date" class="block text-sm font-medium text-ink-700 mb-1">Handover to Community Date</label>
            ...
            <!-- Coordinates -->
            <div>
                <label for="northening" class="block text-sm font-medium text-ink-700 mb-1">Northening</label>
            ...
            <div>
                <label for="easting" class="block text-sm font-medium text-ink-700 mb-1">Easting</label>
            ...
            <div>
                <label for="elevation" class="block text-sm font-medium text-ink-700 mb-1">Elevation</label>
...
<style scoped>
.input-compact {
    @apply appearance-none block w-full px-3 py-1.5 border max-w-64  border-ink-300 rounded-md shadow-sm placeholder-ink-400 focus:outline-none focus:ring-accent-500 focus:border-accent-500 sm:text-sm;
}
label {
