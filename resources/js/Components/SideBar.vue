...
<template>
    ...
    <aside
        ...
        class="fixed inset-y-0 left-0 w-72 bg-gradient-to-b from-[#0f2a1b] via-[#122f1f] to-[#0c1f15] text-white p-5 space-y-8 z-50 transform md:relative md:translate-x-0 transition-transform duration-300 ease-in-out shadow-2xl"
    >
        <div class="flex items-center justify-between h-14 rounded-xl bg-white/5 px-4 ring-1 ring-white/10">
            <Link :href="route('dashboard')" class="text-xl font-bold tracking-wide text-white">
                SRSP PEACE 2
            </Link>
            <span class="material-symbols-outlined text-primary bg-white/10 rounded-full p-1">spa</span>
        </div>
        ...
        <nav class="space-y-4 font-medium">
            <h3 class="text-xs uppercase tracking-[0.2em] text-gray-400 px-3">Dashboards</h3>
            ...
            <h3 class="text-xs uppercase tracking-[0.2em] text-gray-400 px-3 pt-2">Modules</h3>
            ...
            <div v-if="isAdmin" class="pt-4 border-t border-gray-800 mt-2">
                <h3 class="text-xs uppercase tracking-[0.2em] text-gray-400 px-3 pt-1 pb-2">Admin</h3>
            ...
            <h3 class="text-xs uppercase tracking-[0.2em] text-gray-400 px-3 pt-4 pb-1">Reports</h3>
