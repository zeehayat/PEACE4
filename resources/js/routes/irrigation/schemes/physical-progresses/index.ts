...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
export const update = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'put',
} => ({
...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
update.url = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    if (Array.isArray(args)) {
        args = {
            scheme: args[0],
            physical_progress: args[1],
...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
update.put = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'put',
} => ({
    url: update.url(args, options),
...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
update.patch = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'patch',
} => ({
    url: update.url(args, options),
...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
export const destroy = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'delete',
} => ({
...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
destroy.url = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    if (Array.isArray(args)) {
        args = {
            scheme: args[0],
            physical_progress: args[1],
...
* @route '/irrigation/schemes/{scheme}/physical-progresses/{physical_progress}'
*/
destroy.delete = (args: { scheme: string | number, physical_progress: string | number } | [scheme: string | number, physical_progress: string | number ], options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'delete',
} => ({
    url: destroy.url(args, options),
