...
* @see app/Http/Controllers/CboTrainingController.php:14
* @route '/cbo/trainings'
*/
...
* @see app/Http/Controllers/CboTrainingController.php:22
* @route '/cbo/trainings'
*/
...
* @see app/Http/Controllers/CboTrainingController.php:85
...
* @see app/Http/Controllers/CboTrainingController.php:94
* @route '/cbo/trainings/{training}'
*/
...
const CboTrainingController = { index, store, show, update, destroy }
