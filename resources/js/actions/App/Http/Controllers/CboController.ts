...
* @see app/Http/Controllers/CboController.php:74
* @route '/cbo/cbos'
*/
...
* @see app/Http/Controllers/CboController.php:89
* @route '/cbo/cbos/{cbo}'
*/
...
* @see app/Http/Controllers/CboController.php:102
* @route '/cbo/cbos/{cbo}'
*/
...
const CboController = { index, create, store, show, edit, update, destroy, autoSearch }
