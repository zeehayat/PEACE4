...
* @route '/mhp/mhp-eme-physical-progresses'
*/
...
index.definition = {
    methods: ['get','head'],
    url: '/mhp/mhp-eme-physical-progresses',
}
...
* @route '/mhp/mhp-eme-physical-progresses/{progress}'
*/
...
update.definition = {
    methods: ['post'],
    url: '/mhp/mhp-eme-physical-progresses/{progress}',
}
...
const MhpEmePhysicalProgressController = { index, store, update, destroy }
