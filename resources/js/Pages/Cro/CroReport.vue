    ...
    <AppLayout title="CRO Report">
        <template #header>
            <div class="flex flex-col gap-1">
                <h2 class="font-semibold text-xl text-ink-800 leading-tight">CRO Report</h2>
                <p class="text-sm text-ink-500">Comprehensive report of Community Representative Organizations.</p>
            </div>
        </template>
