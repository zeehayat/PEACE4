                    ...
                    <table class="table-stitch">
                        ...
                        <tr v-for="site in filteredMhpSites" :key="site.id" class="hover:bg-blue-500/5 transition-colors duration-150 group">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium relative action-menu-container">
                                <button @click.stop="toggleActionMenu(site.id, $event)" class="p-2 text-slate-500 hover:text-slate-900 rounded-full hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity action-menu-trigger">
