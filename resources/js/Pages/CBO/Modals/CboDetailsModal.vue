        ...
        <div class="p-6 overflow-y-auto max-h-[85vh] text-slate-800 print-content">
            ...
            <section class="mb-8 border-b pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                    ...
                    <div class="detail-item"><p class="font-semibold text-slate-700">CBO Name:</p><p>{{ cbo.cbo_name ?? 'N/A' }}</p></div>
                    <div class="detail-item"><p class="font-semibold text-slate-700">Region:</p><p>{{ cbo.region ?? 'N/A' }}</p></div>
